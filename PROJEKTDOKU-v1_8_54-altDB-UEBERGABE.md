...
**Version:** v1.8.54-altDB  
**Stand:** März 2026  
**Entwickler:** Denis-Alexander Stindl  
**Datei:** `index.html` (Single-File PWA, ~373 KB, ~7.031 Zeilen)
...
### Konvertierte Menü-Seiten (vollständig ab v1.8.54)
| Seite | Version | State |
|---|---|---|
| Igel erfassen | v1.8.49 | `showAddForm` |
| Info & Changelog | v1.8.50 | `showChangelog` |
| Datenbank-Hub | v1.8.51 | `showDatenbankHub` |
| Einstellungen | v1.8.52 | `showSettings` |
| To-Do | v1.8.53 | `showTodoList` |
| App Spezifikation | v1.8.54 | `showDesignSpec` |

### Hardware-Back / Browser-Zurück
```javascript
...
| "Missing or insufficient permissions" im Wizard | `medikationen`-Collection fehlt | try-catch in `saveTreatment` |
...
| v1.8.47-altDB | März 2026 | Versionsnummer Sidebar-Fix, Deploy-Automatisierung |
| v1.8.46-altDB | März 2026 | Comic-Süß-Icon Login, PWA App-Icon, Ladezeit-Optimierung |
| v1.8.45-altDB | Feb 2026 | Back-Button, Permissions-Fix, Wizard-Verbesserungen |
...
> "Ich entwickle **Igelpflegestation Pro** — eine Single-File React PWA (`index.html`, ~373KB, **v1.8.54-altDB**).  
...
> Bitte lies zuerst die Projektdokumentation `PROJEKTDOKU-v1_8_54-altDB-UEBERGABE.md`."
